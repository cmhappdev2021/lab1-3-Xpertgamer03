...
var distanceFeet = 50;
var distanceMeters = distanceFeet/3;
...
let heartRate1B: Double = 84.3;
let heartRate2B: Double = 95.7;
let heartRate3B: Double = 77.7;
let averageHRB = heartRate1B + heartRate2B + heartRate3B/3;
...
let tempInCelsius = tempInFahrenheit * (5.0/9.0);
...
let multipliedAsDoubles = Int (x) * Int (y);
print (multipliedAsDoubles);
// Are the values of multipliedAsIntegers and multipliedAsDoubles different? Print a statement to the console explaining why.
//Yes they are different because your are multiplying integers instead of doubles.
...
var percentGoal: Double = (Double(stepsTaken)/Double(goalAgain)) * 100;
print (percentGoal);